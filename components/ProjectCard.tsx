...
const ProjectCard: FunctionComponent<{
  ...
  if (project) {
    if (!currentProject) {
      ...
      return (
        <div className="absolute top-0 left-0 z-10 w-full flex flex-col p-2 text-black bg-gray-100 md:flex-row rounded-lg">
          ...
          <div className="grow mt-2 md:mt-0 mx-4">
            ...
            ></h3>
            <div className="flex flex-wrap mt-5 mb-2 md:mb-20 space-x-2 text-sm tracking-wider">
